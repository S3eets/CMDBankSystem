...
{
    short Choice = ReadInput::ReadIntNumberInRange("Choose what do you want to do? [1 to 4]? ", 1, 4);
    return Choice;
}
...
{
    short Choice = ReadInput::ReadIntNumberInRange("Choose what do you want to do? [1 to 7]? ", 1, 7);
    return Choice;
}
